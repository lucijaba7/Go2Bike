...
class Tariffs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Tariff> tariffList = [
      new Tariff(getTranslated(context, 'standard'), 5, getTranslated(context, 'hour')),
      new Tariff(getTranslated(context, 'daily'), 150, getTranslated(context, 'day')),
      new Tariff(getTranslated(context, 'monthly'), 250, getTranslated(context, 'month'))
    ];
              ...
              Container(
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: "JosefinSansBold", fontSize: 15, fontWeight: FontWeight.w900
                    ),
                  ),
                ),
                Padding(
